package independentwork.main.utils
...
/**
 * Утилиты для работы с файлами описания меню в independentwork.utils.xml
 */
class MenuXml {

    /**
     * Конвертация menu.independentwork.utils.xml в текст json для использования в качестве узлов дерева
    ...
    /**
     * Конвертирует узел independentwork.utils.xml в map(json) для использования в дереве
     */
