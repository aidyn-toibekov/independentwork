package independentwork.utils.dbfilestorage.impl;

import independentwork.utils.dbfilestorage.*;
import independentwork.utils.dbfilestorage.model.*;
import independentwork.utils.dbinfo.*;
import jandcode.app.*;
...
public class DbFileStorageServiceImpl extends DbFileStorageService {
    ...
    public String getStoragePath() {
        if (storagePath == null) {
            synchronized (this) {
                if (storagePath == null) {
                    String sp = getApp().service(DataDirService.class).getDataDir("independentwork/utils/dbfilestorage");
